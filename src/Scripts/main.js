...
import EscenaCreditos from './Scenes/EscenaCreditos.js';
let config = {
    type: Phaser.WEBGL,
    antialias: true,
    antialiasGL: true,
    ...
    scene: [EscenaPrincipal,EscenaSocialTienda,EscenaCombate,EscenaCreditos,EscenaVictoria], //Aquí metemos todas las escenas que tendrá nuestro juego (su clase, luego cambiaremos de una a otra mediante el id)
